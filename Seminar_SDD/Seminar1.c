...
int main()
{
	...
	//cel de sus este un cast explicit
	...
	struct Masina masina2 = initializareMasina("Renault", 2022, 2.49);
	...
	/*afisareMasina(&masina1);*/ //un pointer care pointeaza undeva unde nu e adresa = dangling pointer -> deja dezalocasem gen
